...
const textos = {
    ...
    LEIS, REGULAMENTOS, DIREITOS E DEVERES
    ...
    SEGURANÇA E GARANTIA DE PRIVACIDADE:
    ...
    ATUALIZAÇÃO DOS GUARDIÕES DE APLICAÇÃO EM SAÚDE:
    ...
    RESPONSABILIDADE POR AÇÕES COM BASE NO CONTEÚDO:
    ...
    RESPONSABILIDADE POR PROBLEMAS TECNOLÓGICOS:
    ...
    RESPONSABILIDADE POR INFORMAÇÕES DE TERCEIROS:
